...
describe("tool.registry", () => {
  it.live("loads tools from .mtycoder/tool (singular)", () =>
    provideTmpdirInstance((dir) =>
      Effect.gen(function* () {
        const opencode = path.join(dir, ".mtycoder")
  ...
  it.live("loads tools from .mtycoder/tools (plural)", () =>
    provideTmpdirInstance((dir) =>
      Effect.gen(function* () {
        const opencode = path.join(dir, ".mtycoder")
