export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using MtyCoder, you agree to our ",
  ...
  "tui.tips.share": "Run {highlight}/share{/highlight} to create a public link to your conversation at mtycoder.example.com",
  ...
  "tui.tips.config_files":
    "Create {highlight}mtycoder.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/mtycoder/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "MtyCoder auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.mtycoder/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.mtycoder/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "MtyCoder auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "MtyCoder uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.mtycoder/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.mtycoder/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent MtyCoder from reading sensitive files",
  "tui.tips.run": "Use {highlight}mty run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}mty --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}mty run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}mty serve{/highlight} for headless API access to MtyCoder",
  "tui.tips.attach_server": "Use {highlight}mty run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}mty upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}mty auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}mty agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}mty github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.mtycoder/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}mty debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/matyianyuan/MtyCoder{/highlight} for containerized use",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with MtyCoder for curated, tested models",
  ...
  "tui.toast.update_available.success": "Successfully updated to MtyCoder v{{version}}. Please restart the application.",
  ...
  "tui.voice.error.no_auth": "Use /connect to sign in to MtyCoder, or configure voice.asr_model for another provider",
  ...
  "tui.dialog.login.mtycoder": "MtyCoder",
  "tui.dialog.login.mtycoder.desc": "(Recommended)",
  "tui.dialog.login.mty_free": "MtyCoder Auto (free)",
  "tui.dialog.login.mty_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.mty_free.success": "MtyCoder Auto (free) is ready — default model set to mty/mty-auto",
  "tui.dialog.login.mty_free.unavailable": "MtyCoder Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.mty.recommended_hint": "recommended",
  "cli.providers.mty_free.hint": "Anonymous free channel / mty-auto",
  "cli.providers.mty_free.verifying": "Verifying MtyCoder Auto (free) channel...",
  "cli.providers.mty_free.ready": "MtyCoder Auto (free) channel ready",
  "cli.providers.mty_free.failed": "MtyCoder Auto (free) verification failed",
  "cli.providers.mty_free.default_set": "Default model set to mty/mty-auto (1M context, free)",
  "cli.providers.mty_free.usage_hint": "No login required — just run mty. For paid/premium models, choose MiMo browser login instead.",
  "cli.providers.mty_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.mty_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "tui.dialog.login.flow.title": "MtyCoder Login",
  ...
  "trust.capabilities": "MtyCoder will be able to read, edit, and execute files here.",
