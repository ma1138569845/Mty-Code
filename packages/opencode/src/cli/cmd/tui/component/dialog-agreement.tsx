...
export const FREE_MODEL_IDS = new Set(["mty-auto", "mty-free"])

const TERMS_URL = "https://platform.mtycoder.example.com/docs/terms/user-agreement"
const PRIVACY_URL = "https://privacy.mi.com/matyianyuanPlatform"
