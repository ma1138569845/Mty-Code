...
function pagerCmd(): string[] {
  ...
  if (Flag.MTYCODER_GIT_BASH_PATH) {
    const less = path.join(Flag.MTYCODER_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into mtycoder",
  builder: (yargs: Argv) =>
    yargs.option("force", {
