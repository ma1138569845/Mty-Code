...
const EVENT_QUEUE_CAPACITY = Number(process.env["MTYCODER_EVENT_QUEUE_CAPACITY"]) || 10_000
...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the MtyCoder server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the MtyCoder system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global MtyCoder configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global MtyCoder configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all MtyCoder instances, releasing all resources.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description:
          "Import sessions from external AI tools (Claude Code, Codex, opencode) into mtycoder. Idempotent; pass force to re-sync. Per-source failures are not thrown as HTTP errors — they are collected into the corresponding stats.errors[] while other sources continue.",
