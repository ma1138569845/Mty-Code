...
// Provider IDs served by the MtyCoder model gateway. Its error bodies carry
...
const MIMO_GATEWAY_PROVIDERS = new Set(["mtycoder", "mty"])

// MtyCoder gateway error.code values worth relabeling: moderation (421) and
...
function message(providerID: ProviderID, e: APICallError) {
  return iife(() => {
    // MtyCoder gateway: relabel known block codes and surface error.param (the real
