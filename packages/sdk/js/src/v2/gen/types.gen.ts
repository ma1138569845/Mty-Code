...
export type QuestionInfo = {
  ...
  key?: string
  /**
   * Template parameters for i18n interpolation (e.g. { plan: '.mtycoder/plans/...' })
   */
  params?: {
    [key: string]: string
  }
...
/**
 * Server configuration for mty serve and web commands
 */
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://mtycoder.example.com/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://mtycoder.example.com/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
