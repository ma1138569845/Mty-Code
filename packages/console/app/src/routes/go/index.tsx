...
import { IconMiniMax, IconMtyCoder, IconZai, IconAlibaba } from "~/component/icon"
...
const models = [
  ...
  { name: "MtyCoder-V2-Pro", provider: "Dechnic" },
  { name: "MtyCoder-V2-Omni", provider: "Dechnic" },
...
function LimitsGraph(props: { href: string }) {
  ...
  const graph = [
    ...
    { id: "mty-v2-pro", name: "MtyCoder-V2-Pro", req: 1290, d: "150ms" },
            ...
            <div data-slot="hero-copy">
              ...
              <div data-slot="model-logos">
                ...
                */}
                ...
                <div>
                  <IconMtyCoder width="24" height="24" />
                </div>
                {/*
                <div>
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
