...
import { base64Encode } from "@mty-coder/shared/util/encode"
import { decode64 } from "@/utils/base64"
import { ResizeHandle } from "@mty-coder/ui/resize-handle"
...
import { Session, type Message } from "@mty-coder/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@mty-coder/ui/toast"
...
import { retry } from "@mty-coder/shared/util/retry"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://mtycoder.example.com/desktop-feedback")}
      renderPanel={() =>
