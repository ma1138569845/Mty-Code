...
beforeAll(async () => {
  ...
  mock.module("@mty-coder/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@mty-coder/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@mty-coder/ui/icon", () => ({ Icon: () => null }))
  mock.module("@mty-coder/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
