...
const releaseId = process.env.MTYCODER_RELEASE
if (!releaseId) throw new Error("MTYCODER_RELEASE is required")

const version = process.env.MTYCODER_VERSION
if (!version) throw new Error("MTYCODER_VERSION is required")
